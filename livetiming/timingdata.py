...
def GetTimingData(BaseURL, Year, RaceID, RaceSession, OutputLocation):
    
    logging.info("Starting to get timing Data")

    Endpoint = 'TimingData.jsonStream'
    ...
    f = open(OutputLocation + '/TimingData.csv', 'w')
